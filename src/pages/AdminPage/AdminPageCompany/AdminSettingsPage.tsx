...
export default function AdminSettingsPageCompany() {
    ...
    const handleSave = async () => {
        ...
        try {
            const res = await fetch('/admin/settings/company', {
                method: 'POST',
            ...
            <main className={styles.main}>
                <div className={styles.dashboard} style={{ maxWidth: '900px' }}>
                    <h1 className={styles.dashboardTitle}>
                        ...
                        Admin LLM Configuratie Companies
                    </h1>

...
interface SearchPageCompanyProps {
    onSearch?: (query: string, filters: Filters) => void;
}

// ── Component ─────────────────────────────────────────────────────────────────

export default function SearchPageCompany({ onSearch }: SearchPageCompanyProps) {
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        console.log('Zoekopdracht ingediend:', { query, filters });
    };
